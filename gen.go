...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target amd64 -cflags "-g -O2 -Wall -D __TARGET_ARCH_x86" topic_message_counter topic_message_counter.bpf.c
